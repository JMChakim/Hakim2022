...
Datastep
```{r}
path = "../raw_and_processed_fastq/fastq_processed/primer_trimmed/RV/"
#list.files(path)
...
Quality check
```{r}
pdf("../dada2/Diagnostic_graphs/Quality_rv_R1_head.pdf", height = 10, width = 10)
plotQualityProfile(fnFs[1:12])
dev.off()

pdf("../dada2/Diagnostic_graphs/Quality_rv_R2_head.pdf", height = 10, width = 10)
...
saveRDS(errF, file = "errF_rv.rds")
saveRDS(errR, file = "errR_rv.rds")

#errF = readRDS(file = "./errF_rv.rds")
#errR = readRDS(file = "./errF_rv.rds")

```

```{r}
pdf("../dada2/Diagnostic_graphs/errorsR1_Rv.pdf", height = 10, width = 10)
plotErrors(errF, nominalQ=TRUE)
dev.off()

pdf("../dada2/Diagnostic_graphs/errorsR2_Rv.pdf", height = 10, width = 10)
...
write.csv(seqtab, "../dada2/out/seqtab_rv.csv")
...
write.csv(seqtab.nochim, "../dada2/out/seqtab_nochim_rv.csv")
...
track
write.csv(track, "../dada2/out/tracked_reads_rv.csv")
```
